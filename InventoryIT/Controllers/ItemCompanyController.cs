...
namespace InventoryIT.Controllers
{
    public class ItemCompanyController : Controller
    {
        ...
        public ItemCompanyController(IItemCompanytRepository itemCompanytRepository, IMastBranchRepository mastBranchRepository, IMastCompRepository mastCompRepository, IFinancialYearRepository financialYearRepository, IUserMasterRepository userMasterRepository)
        {
